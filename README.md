...
To simplify the process of setting up your own data receiver from the DharitrI blockchain node, we have created this
repository as a comprehensive template. It serves as a valuable resource, guiding you through the necessary steps to
establish a successful connection with the DharitrI blockchain node and receive the exported data effortlessly.
...
from the DharitrI blockchain node.
...
[from this config file](https://github.com/TerraDharitri/drt-go-chain/blob/master/cmd/node/config/external.toml)
