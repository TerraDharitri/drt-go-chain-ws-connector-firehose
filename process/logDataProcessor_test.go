...
func TestLogDataProcessor_ProcessPayload(t *testing.T) {
	...
	t.Run("invalid topic, should return error", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), "invalid topic", 0)
	...
	t.Run("save block", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicSaveBlock, 0)
		...
		err = dp.ProcessPayload(outportBlockBytes, outport.TopicSaveBlock, 0)
	...
	t.Run("revert indexed block", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicRevertIndexedBlock, 0)
		require.NotNil(t, err)
		require.Equal(t, 0, logInfoCalledCt)
		...
		err = dp.ProcessPayload(blockDataBytes, outport.TopicRevertIndexedBlock, 0)
		require.Nil(t, err)
		require.Equal(t, 1, logInfoCalledCt)
	})
	...
	t.Run("save rounds", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicSaveRoundsInfo, 0)
		require.NotNil(t, err)
		require.Equal(t, 0, logInfoCalledCt)
		...
		err = dp.ProcessPayload(roundsInfoBytes, outport.TopicSaveRoundsInfo, 0)
		require.Nil(t, err)
		require.Equal(t, 1, logInfoCalledCt)
	})
	...
	t.Run("save validators rating", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicSaveValidatorsRating, 0)
		require.NotNil(t, err)
		require.Equal(t, 0, logInfoCalledCt)
		...
		err = dp.ProcessPayload(ratingDataBytes, outport.TopicSaveValidatorsRating, 0)
		require.Nil(t, err)
		require.Equal(t, 1, logInfoCalledCt)
	})
	...
	t.Run("save validators pubKeys", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicSaveValidatorsPubKeys, 0)
		require.NotNil(t, err)
		require.Equal(t, 0, logInfoCalledCt)
		...
		err = dp.ProcessPayload(validatorsPubKeysBytes, outport.TopicSaveValidatorsPubKeys, 0)
		require.Nil(t, err)
		require.Equal(t, 1, logInfoCalledCt)
	})
	...
	t.Run("save accounts", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicSaveAccounts, 0)
		require.NotNil(t, err)
		require.Equal(t, 0, logInfoCalledCt)
		...
		err = dp.ProcessPayload(accountsBytes, outport.TopicSaveAccounts, 0)
		require.Nil(t, err)
		require.Equal(t, 1, logInfoCalledCt)
	})
	...
	t.Run("finalized block", func(t *testing.T) {
		...
		err := dp.ProcessPayload([]byte("payload"), outport.TopicFinalizedBlock, 0)
		require.NotNil(t, err)
		require.Equal(t, 0, logInfoCalledCt)
		...
		err = dp.ProcessPayload(finalizedBlockBytes, outport.TopicFinalizedBlock, 0)
		require.Nil(t, err)
		require.Equal(t, 1, logInfoCalledCt)
	})
}
